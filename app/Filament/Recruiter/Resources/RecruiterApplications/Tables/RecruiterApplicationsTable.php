            ...
            ->recordActions([
                Action::make('view_profile')
                    ...
                    ->extraModalFooterActions(function (JobApplication $record): array {
                        ...
                        if (! in_array($record->status, ['company_accepted', 'not_passed', 'rejected'])) {
                                ...
                                ->schema([
                                    Grid::make(2)->schema([
                                        ...
                                        Placeholder::make('application_status')
                                            ...
                                            ->content(self::getStatusLabel($record->status)),
