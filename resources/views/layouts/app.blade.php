    ...
    <nav class="bg-white shadow">
        <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
            <div class="flex items-center gap-6">
                <a href="{{ route('student.dashboard') }}" class="text-lg font-bold text-gray-800">Japan Work Program</a>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative">
                    <button onclick="document.getElementById('notif-dropdown').classList.toggle('hidden')" class="relative text-gray-600 hover:text-amber-600">
                        ...
                        @if ($unreadCount > 0)
                            <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs w-4 h-4 rounded-full flex items-center justify-center">{{ $unreadCount > 9 ? '9+' : $unreadCount }}</span>
                        @endif
                    </button>
